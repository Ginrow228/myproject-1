...
UPDATE books SET genre = 'Сатира' WHERE title = 'Скотный двор'

update borrowed_books set status = 'returned', return_date = '2025-03-23' where borrow_id = 1

delete from readers where id = 4

delete from borrowed_books where book_id = 1
